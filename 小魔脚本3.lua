...
Section:Button("doors", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/4v5n7n/lllllllllllllllllllll/main/doors(1).lua"))()
end)
    
Section:Button("doors变怪", function()
